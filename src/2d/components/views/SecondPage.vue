<template>
  <section class="left">
    ...
    <card-chunk
      style="height: 4rem; margin-top: 0.25rem"
      title="测量头当天入库量"
    >
        ...
        <template v-slot:tbody>
          <table class="table table_wrapper tbody" cellspacing="0">
            ...
            <tbody>
              <tr
                class="td_tr"
                v-for="(item, index) in status.dataSNStockList"
                :key="index"
              >
    ...
    <card-chunk
      style="height: 2.87rem; margin-top: 0.36rem"
      title="PDS当天入库量"
    >
      <div class="dtrkl">
        <div class="icon">
  ...
  <section class="right">
    <card-chunk style="height: 3.48rem" title="PDS当天计划实时数据">
      <div class="jhsssj">
        <div class="item">
          <div class="img-box">
            <img
              src="@/2d/assets/img/second/realtime-plan-box-img1.png"
              alt=""
            />
          </div>
          <div class="right-box">
        ...
        <div class="item">
          <div class="img-box">
            <img
              src="@/2d/assets/img/second/realtime-plan-box-img2.png"
              alt=""
            />
          </div>
          <div class="right-box">
    ...
    <card-chunk
      style="height: 6.09rem; margin-top: 0.38rem"
      title="PDS当天过程数据"
    >
    </card-chunk>
  </section>
